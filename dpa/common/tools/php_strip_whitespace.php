<?php
/**
 * 线上去掉所有注释 php_strip_whitespace , 使用方法：
 * php php_strip_whitespace.php -p /data0/deve/runtime
 * php php_strip_whitespace.php -p /data0/htdocs/admin/dpa
 * php /data0/deve/runtime/common/tools/php_strip_whitespace.php -p /data0/htdocs/admin/dpa/WEB-INF/Business -f Topublishdocs_editAction.cls.php

   php D:/www/dpa/common/tools/php_strip_whitespace.php -p D:/www/dpa -t D:/www/dpa_strip_whitespace

   php P:/develope/www/dpa/work/common/tools/php_strip_whitespace.php -p P:/develope/www/dpa/work -t D:/dpa
 */
...
$_no_need_file = array(basename(__FILE__),'system.conf.php','UIBI_SIGN.conf.php','db.conf.php','MDB2_db.conf.php','overfile.php','chinese.utf8.lang.php','doc');
...
function tOne($s_path,$s_file,$tar_path,$tar_file,$tar_charact="utf-8"){
  ...
  if (file_exists($s_path."/".$s_file)) {
    ...
    $cont = php_strip_whitespace($s_path."/".$s_file);  // 去掉所有的注释和空白
