 ...
 * 抓取经济通数据
 *   资金流向
  http://www.etnet.com.hk/www/sc/warrants/turnover_ratio.php

  街货分布
  http://www.etnet.com.hk/www/sc/warrants/turnover_outstanding.php
 *
 */
...
define("COMM_URL", "http://www.etnet.com.hk/www/sc/warrants/");
$table_name_arr = array(
  // 街货分布
  "turnover_ratio"  => array(
              "t_name_cn"=>"基本资料",
              "f_uni"=>array("symbol"),
            ),
  // 资金流向
  "turnover_outstanding"    => array(
